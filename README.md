...
| Package | Purpose |
|---|---|
| [`fx-rates`](https://www.npmjs.com/package/fx-rates) | Simple one-function library + CLI |
| [`@allratestoday/sdk`](https://www.npmjs.com/package/@allratestoday/sdk) | Full-featured SDK (historical, batch, webhooks) |
| [`react-currency-localizer-realtime`](https://www.npmjs.com/package/react-currency-localizer-realtime) | React hooks & components |
| **`moneyify`** *(this package)* | **Cashify-compatible conversion + auto-fetch** |
